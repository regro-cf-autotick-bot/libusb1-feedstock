...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/libusb1-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14055&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/libusb1-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `libusb1` can be installed with:

```
conda install libusb1
```

It is possible to list all of the versions of `libusb1` available on your platform with:
